# v5.11.0: Tokens & Emblems

**Released**: 2026-08-26

## Highlights

Decks that create tokens or emblems now surface them directly: a new "Tokens & Emblems Created" section appears in the deck summary and file exports, tokens and emblems are searchable in the card browser, and a "Choose Printing" picker lets you pick a specific art/printing for any token, all backed by matching public API fields for the mobile app. Also includes a card browser pagination option and a fix for excess spacing between card tiles.
